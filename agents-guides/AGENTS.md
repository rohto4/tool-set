...
**例**:
```
参照: docs/lv2/data-schema.md
更新: docs/lv3/component-spec.md
...
**例**:
```typescript
// 要件: docs/lv4/01-posts-feature.md - 記事詳細ページ
// - 目次自動生成（h2/h3から）
// - 関連記事表示（同じタグを持つ記事）
